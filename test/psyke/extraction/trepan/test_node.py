...
class TestNode(unittest.TestCase):
    ...
    virginica_10 = Node(dataset.iloc[95:110, :], n_examples)
    versicolor_50 = Node(dataset.iloc[20:130, :], n_examples)

    def test_reach(self):
        node = Node(self.dataset, self.n_examples)
        self.assertEqual(node.reach, self.all_node.reach)
        self.assertTrue(self.virginica_10.reach < self.setosa_40.reach)
        self.assertTrue(self.setosa_40.reach < self.versicolor_50.reach)
        self.assertTrue(self.versicolor_50.reach < self.all_node.reach)

    def test_dominant(self):
        self.assertEqual('setosa', self.setosa_40.dominant)
        self.assertEqual('virginica', self.virginica_10.dominant)
        self.assertEqual('versicolor', self.versicolor_50.dominant)

    def test_correct(self):
        self.assertEqual(50, self.versicolor_50.correct)
        self.assertEqual(40, self.setosa_40.correct)
        self.assertEqual(10, self.virginica_10.correct)

    def test_fidelity(self):
        self.assertEqual(50 / 150, self.all_node.fidelity)
        self.assertEqual(40 / 60, self.setosa_40.fidelity)
        self.assertEqual(10 / 15, self.virginica_10.fidelity)
        self.assertEqual(50 / 110, self.versicolor_50.fidelity)

    def test_priority(self):
        self.assertTrue(self.all_node.priority < self.versicolor_50.priority)
        self.assertTrue(self.versicolor_50.priority < self.setosa_40.priority)
        self.assertTrue(self.setosa_40.priority < self.virginica_10.priority)

    def test_n_classes(self):
        self.assertEqual(3, self.all_node.n_classes)
        self.assertEqual(2, self.virginica_10.n_classes)
        self.assertEqual(2, self.setosa_40.n_classes)
        self.assertEqual(3, self.versicolor_50.n_classes)
