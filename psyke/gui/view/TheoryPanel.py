...
class TheoryPanel(VerticalBoxLayout):
    ...
    def __init__(self, controller, **kwargs):
        ...
        self.theory_label = Label(text=THEORY_MESSAGE, size_hint=(None, None), size=(800, 250))
    ...
    def set_info(self):
        ...
        if theory is not None:
            ...
            if n_rules > 6:
                self.theory_label.text = THEORY_ERROR_MESSAGE
            else:
                self.theory_label.text = pretty_theory(theory) + '\n' * (6 - n_rules) * 2
        else:
            self.theory_label.text = THEORY_MESSAGE
