...
from psyke.classification.trepan import Trepan
    ...
    def reset(self, extractor=None, model=None):
        if extractor is None:
            ...
            if isinstance(extractor, Trepan):
                ...
                self.label.text += f'Extractor: CART\nSimplify theory: {extractor.simplify}'
                ...
                if isinstance(model, RegressorMixin):
                    self.label.text += f'Constant output: {extractor.output == ClusterExtractor.Target.CONSTANT}\n'
